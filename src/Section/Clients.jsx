...
import { client } from '../components/export'; // Assuming this is your client data
        ...
        >
          {client.map((item, index) => (
            <div
              ...
              data-aos-delay="200"
              key={index}
              className="bg-white dark:bg-gray-900 hover:bg-red-100 cursor-pointer p-12 flex flex-col justify-center items-center gap rounded-xl w-full"
            >
