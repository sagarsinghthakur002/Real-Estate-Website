    ...
    <>
      <footer
        className={`${darkMode ? "dark bg-black" : "light bg-gray-800"} 
          w-full m-auto lg:px-20 px-10 py-20 grid lg:grid-cols-3 grid-cols-1 
          justify-center items-start lg:gap-20 gap-10`}
      >
        {/* About Us Section */}
        ...
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <div className="flex justify-center items-center gap-3">
            ...
            <p className="text-slate-200">+977 9823405745</p>
          </div>
          <div className="flex justify-center items-center gap-3">
            <FaFax className="text-white size-5" />
            <p className="text-slate-200">+977 9822763996</p>
          </div>
          <div className="flex justify-center items-center gap-3">
            <IoMdMail className="text-white size-5" />
            <p className="text-slate-200">realestate002@gmail.com</p>
          </div>
        </div>
        ...
        <div className="flex flex-col justify-center items-start gap-5">
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            />
            <div>
              <h1 className="text-lg text-white">Sea View from beach</h1>
              <p className="text-slate-400">$ 517.68</p>
            </div>
          </div>
        </div>
      </footer>
      ...
      <div>
        <button onClick={toggleDarkMode} className="flex items-center p-4 rounded-full bg-orange-500 fixed lg:top-20 right-6 top-16" >
